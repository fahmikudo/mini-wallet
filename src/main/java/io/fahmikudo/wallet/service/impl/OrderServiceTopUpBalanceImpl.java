...
public class OrderServiceTopUpBalanceImpl implements OrderServiceTopUpBalance {
    ...
    public OrderServiceTopUpBalanceImpl(OrderValidator orderValidator, OrderRepository orderRepository) {
    ...
    @Override
    public OrderTopUpResponse orderTopUp(User user, OrderTopUpRequest orderTopUpRequest) throws HttpException {
